...
GET /api/config/tables      # テーブル一覧取得
GET /api/config/data/{table} # データ一覧取得
POST /api/config/data/{table} # データ作成
PUT /api/config/data/{table}/{id} # データ更新
DELETE /api/config/data/{table}/{id} # データ削除
```
